...
\- 11 deterministic Neural Routing shadow tests, including malformed comparison-input normalization, data-quality reporting, and Pulse-level comparison-output contract locking
