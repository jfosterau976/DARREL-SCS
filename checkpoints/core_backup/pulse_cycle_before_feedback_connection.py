...
def run_pulse(question, feedback=None):
    ooda_state = ooda_loop.observe(question)

    print("\n[OODA OBSERVE]")
    print(ooda_state)
    print("\nSCS PULSE")
    print("Question:", question)
    ooda_context = ooda_loop.orient(ooda_state)

    print("\n[OODA ORIENT]")
    print(ooda_context)
    ooda_decision = ooda_loop.decide(ooda_context)

    print("\n[OODA DECIDE]")
    print(ooda_decision)
    print("\n[OODA ACT]")
    print("Executing cognitive pulse...")
    decision = pulse_router.decide(
        question,
        feedback
    )
    if not feedback:
        decision = ooda_decision["strategy"]
    print("\nROUTER DECISION:")
    print(decision)
