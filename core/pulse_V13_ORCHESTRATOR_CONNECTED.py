...
from core.adaptive_effort_controller import adaptive_effort_controller
from core.effort_activation_map import effort_activation_map
...
class PulseController:
    ...
    def run(self, question, feedback=None):
        ...
        effort_result = adaptive_effort_controller.evaluate(
            {
                "complexity": attention_result["cognitive_state"]["complexity"],
                "risk": attention_result["cognitive_state"]["risk"],
                "memory_count": len(memory_context),
                "uncertainty": "low"
            }
        )
        activation_result = effort_activation_map.activate(
            effort_result["effort_level"]
        )
        ...
        execution_result = pulse_orchestrator.execute(
            execution_plan,
            {
                "question": question
            }
        ...
        if decision["verifier"]:
            ...
            return {
                ...
                "effort_activation": activation_result,
    ...
    def summarize_execution(self, execution_result):
        ...
        return {
            "orchestrator": execution_result.get(
                "orchestrator"
            ),

            "executed_modules": execution_result.get(
                "executed_modules",
                []
            ),
